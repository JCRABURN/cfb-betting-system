...
All four fixed and tested (regression tests added in `test_fetch_odds.py`, `test_pool_view.py`, `test_build_dashboard.py`, `test_post_game_audit.py`); full suite green (345 tests) before commit.
